...
function TableCellResizer({editor,divRef}: {editor: LexicalEditor,divRef:HTMLDivElement}): JSX.Element {
 ...
 useEffect(() => {
   ...
   divRef.addEventListener('mousemove', onMouseMove);


   return () => {
     console.log('removing element');
     divRef.removeEventListener('mousemove', onMouseMove);
   };
...
}:
{
 ...
 return useMemo(
   () =>
     isEditable && divRef
       ? createPortal(<TableCellResizer editor={editor} divRef={divRef} />, document.body)
       : null,
   [editor, isEditable],
 );
}
