...
function setMenuPosition(
  ...
  buttonElem.style.transform = `translate(${anchorElementRect.width/2}px, ${top + 8 - anchorElementRect.height}px)`;
}
...
function useDraggableBlockMenu(
  ...
  return createPortal(
    <>
      ...
      <div className="absolute" ref={buttonRef}>
      <DropDown
            fromPresentation={false}
            disabled={!isEditable}
            buttonClassName="bg-[#37888d] rounded-[50%] text-white w-[50px] h-[50px]"
            buttonLabel=""
