      ...
      {nodes && !Loading && nodes.length > 0 ? (
        nodes?.map((node) => (
          ...
          >
            <PopoverTrigger>
              <div
                onContextMenu={(event) => handleContextMenu(event, node?._id)}
                key={node?._id}
              ...
              >
                ...
                >
                  {node?.isFile === '0' ? (
                    <FolderOpen size={80} color="#05686E" />
                  ) : (
                    <Image alt='file' src="images/tSample.svg" width={80} height={20} />
                    // <FileText size={80} color="#05686E" />
                  )}
            ...
            <PopoverContent>
              <ul className="min-w-[200px] py-1">
                ...
                <li
                  ...
                  className={`${node?.url ? 'flex' : 'hidden'
                    } items-center gap-1 py-1 px-2 hover:bg-gray-100 cursor-pointer rounded-lg`}
                >
        ...
        <>
          ...
          {Loading ? (
            ...
            <div className="flex flex-col justify-center items-center gap-2 m-auto">
              ...
              <p className="text-[12px] text-black pl-12">
              Add favorite file or folder you want to easily find later
              </p>
            </div>
          )}
        </>
