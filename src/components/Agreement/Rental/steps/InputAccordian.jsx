...
if(name === "tenant"){
  ...
  address = `tenants[${index}].address`;
  touchedaddress = getIn(touched, address);
  erroraddress = getIn(errors, address);
  
  aadhar = `tenants[${index}].aadhar`;
  touchedaadhar = getIn(touched, aadhar);
  erroraadhar = getIn(errors, aadhar);
}
