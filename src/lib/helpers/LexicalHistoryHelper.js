...
'use strict';
import { $isRangeSelection, $isRootNode, $isTextNode, CAN_REDO_COMMAND, CAN_UNDO_COMMAND, CLEAR_EDITOR_COMMAND, CLEAR_HISTORY_COMMAND, COMMAND_PRIORITY_EDITOR, REDO_COMMAND, UNDO_COMMAND } from "lexical";
...
function createMergeActionGetter(editor, delay) {
  ...
  return (prevEditorState, nextEditorState, currentHistoryEntry, dirtyLeaves, dirtyElements, tags) => {
    ...
    if (tags.has('historic') || tags.has('pageOperation')) {
 ...
 */
export function registerHistory(editor, historyState, delay,addHistory,pageIndex) {
  ...
  const applyChange = ({
    ...
    if (mergeAction === HISTORY_PUSH) {
      ...
      if (current !== null) {       
        ...
        editor.dispatchCommand(CAN_UNDO_COMMAND, true);
        addHistory(current, "lexical",pageIndex);
      }
